...
public class MoviesDao {
    ...
    private static final String ADD_MOVIE = "INSERT INTO PHIM (TEN_PHIM, QUOC_GIA, THOI_LUONG, THE_LOAI, DIEN_VIEN, NGAY, SO_LUONG_VE) " +
            "VALUES ( ?, ?, ?, ?, ?, ?, ?)";
    ...
    public int addMovie(Connection connection, Movie movie) {
        ...
        try {
            ...
            preparedStatement.setString(2, movie.getQuoc_gia());
            preparedStatement.setString(3, movie.getThoi_luong());
            preparedStatement.setString(4, movie.getThe_loai());
            preparedStatement.setString(5, movie.getDien_vien());
            preparedStatement.setString(6, movie.getNgay_chieu());
            preparedStatement.setInt(7, movie.getSo_Luong_Ve());
    ...
    public int deleteMovie(Connection connection, int movieID) {
        int result = 0;
        PreparedStatement preparedStatement = null;
    ...
    public int updateMovie(Connection connection, Movie movie) {
        int result = 0;
        PreparedStatement preparedStatement = null;
    ...
    public void updateMovie(Connection connection,Integer id, String name, String quoc_gia, String the_loai, String thoi_luong, String dien_vien, String ngay_chieu, Integer so_luong_ve) {
        int result = 0;
        PreparedStatement preparedStatement = null;
